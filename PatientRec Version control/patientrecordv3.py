...
class PatientGame:
    def __init__(self, directory_path=r"/home/mel/nvme1/Downloads/Muzero_files/Muzero files/FinalRecords", seed=None):
        super().__init__()
    ...
    def render(self):
        ...
        labels = ["Systolic Blood Pressure", "Diastolic Blood Pressure", "Heart Rate"]
